...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Duplicate carousel items for smooth infinite scroll
  const carouselInner = carousel.querySelector('.tech-carousel');
  ...
  function autoScroll() {
    ...
    if (scrollAmount >= carouselInner.scrollWidth / 2) {
